                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">View User</h4>  
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                              ...
                                              $select_cat="SELECT * FROM librarian_registration where roles='sub' ORDER BY id DESC";
                                              $run_cart=mysqli_query($con, $select_cat);
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                               ?>
                                                <tr>
                                                <td>
                                                <img src="admin_images/<?php echo $row_cart["images"]; ?>" width="50" height="50"></td>
                                                <td><?php echo $row_cart["firstname"] ?> <?php echo $row_cart["lastname"] ?></td>
                                               ...
                                               <?php 
                                                ...
                                                <td><a href="delete-user.php?user_id=<?php echo $row_cart["id"];?>" class="btn-delete"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-user.php?user_id=<?php echo $row_cart["id"];?>" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                                </tr>
                                                <?php 
                                                 }?>
                                            </tbody>
